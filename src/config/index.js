...
const colors = {
  ...
  green: '#73B879',
  darkGrey: "#343434",
  shippingPrice: '#989fa7',
  trashIcon: rgba('#1f2727', 50),
  default: '#EFEFF4',
  darkblue: '#00548d',
  great: '#ffa900',
  new: '#ff4f00',
...
const URL = 'http://www.staging.hunting-exchange.com';

const API_URL = 'https://www.dev.golfing.brsw.io';

const store = '5';

const background = require("./../assets/background/image.png");

const logo = require("./../assets/background/logo.png");

const plus = require("./../assets/background/plus.png");

const drawers = {
    news: require("./../assets/drawer/newspapers.png"),
    updates: require("./../assets/drawer/updates.png"),
    logout: require("./../assets/drawer/logout.png"),
};

const icons = {
    bluehome: require("./../assets/icons/blue-home.png"),
    bluestar: require("./../assets/icons/blue-star.png"),
    bluetag: require("./../assets/icons/blue-tag.png"),
    bluechat: require("./../assets/icons/blue-chat.png"),
    blueuser: require("./../assets/icons/blue-user.png"),
    greyhome: require("./../assets/icons/grey-home.png"),
    greystar: require("./../assets/icons/grey-star.png"),
    greytag: require("./../assets/icons/grey-tag.png"),
    greychat: require("./../assets/icons/grey-chat.png"),
    greyuser: require("./../assets/icons/grey-user.png"),
};

const welcome = require("./../assets/background/welcome.png");

const dropdown = require("./../assets/background/dropdown.png");

const suitcase = require("./../assets/suitcase/suitcase.png");

const condition = ["Fair", "Good", "Great", "New"];

const flexes = [
  'Regular Flex', 'Stiff Flex', 'Extra Stiff Flex', 'Tour Flex', 'Senior Flex',
  'Ladies Flex', 'Other'];
...
const states = [
  ...
  { country: 'United States', state: 'American Samoa'},
  ...
  { country: 'United States', state: 'Federated States of Micronesia'},
  { country: 'United States', state: 'Florida'},
  { country: 'United States', state: 'Georgia'},
  { country: 'United States', state: 'Guam'},
  ...
  { country: 'United States', state: 'Marshall Islands'},
  ...
  { country: 'United States', state: 'Palau'},
  ...
  { country: 'United States', state: 'Virgin Island'},
  ...
  { country: 'Canada', state: 'Yukon Territory'}

];


const genders = ["Men's", "Women's", "Junior"];
...
const conditionDescription = {
  New: {
    description: `\nHas never been used.\nIncludes original packaging.\nUnblemished and functions as intended.`
  },
  Good: {
    description:
      "\nUsed but still in good condition.\nMinor blemishes expected.\nProduct still looks and functions as intended."
  },
  Great: {
    description:
  ...
  Fair: {
    description:
      "\nModerate blemishes.\nProduct has been used significantly.\nStill in useful condition."
  }
};


// todo: check all these fonts on IOS (after installing Xcode)
const fonts = {
    robotoMedium: 'Roboto-Medium',
    robotoRegular: 'Roboto-Regular',
    robotoLight: 'Roboto-Light',
    robotoBold: 'Roboto-Bold',
    robotoCondensed: Platform.OS === 'ios' ? 'Roboto Condensed' : 'RobotoCondensed-Regular',
};
...
const user = {
  ...
  country_id: "Canada",
  region: 'Quebec',
  telephone: "+1 555-666-7799",
  postcode: '49055',
  card: '40430812345632'
};

const categories = {
  100: require('../assets/categories/bags.png'),
  77: require('../assets/categories/drivers.png'),
  78: require('../assets/categories/hybrids.png'),
  79: require('../assets/categories/irons.png'),
  80: require('../assets/categories/putters.png'),
  173: require('../assets/categories/shoes.png'),
  91: require('../assets/categories/wedges.png'),
  101: require('../assets/categories/woods.png'),
  174: require('../assets/categories/apparel.png'),
  81: require('../assets/categories/other.png'),

  // SUBCATEGORY
  187: require('../assets/subcategories/balls.png'),
  194: require('../assets/subcategories/cart.png'),
  188: require('../assets/subcategories/gloves.png'),
  208: require('../assets/subcategories/gps.png'),
  190: require('../assets/subcategories/grips.png'),
  191: require('../assets/subcategories/headcovers.png'),
  207: require('../assets/subcategories/memorabilia.png'),
  82: require('../assets/subcategories/rangerfinder.png'),
  192: require('../assets/subcategories/shafts.png'),
  195: require('../assets/subcategories/spikes.png'),
  197: require('../assets/subcategories/sunglasses.png'),
  196: require('../assets/subcategories/tees.png'),
  199: require('../assets/subcategories/towels.png'),
  189: require('../assets/subcategories/trainings-aids.png'),
  198: require('../assets/subcategories/umbrella.png'),
  209: require('../assets/subcategories/art.png'),
  193: require('../assets/subcategories/other.png'),
  176: require('../assets/subcategories/shirts.png'),
  177: require('../assets/subcategories/shorts.png'),
  183: require('../assets/subcategories/skirts.png'),
  178: require('../assets/subcategories/pants.png'),
  184: require('../assets/subcategories/hats.png'),
  185: require('../assets/subcategories/rain.png'),

  // SPECIALS
  215: require('../assets/categories/215.png'),
  220: require('../assets/categories/220.png')
};

const brands = [
  {id: "379", name: "Bridgestone"},
  {id: "267", name: "Callaway"},
  {id: "403", name: "Cleveland"},
  {id: "384", name: "Mizuno"},
  {id: "385", name: "Nike"},
  {id: "449", name: "Ping"},
  {id: "450", name: "Scotty Cameron"},
  {id: "387", name: "Srixon"},
  {id: "358", name: "TaylorMade"},
  {id: "389", name: "Titleist"}
];
